...
write.table(null,paste0("/Users/zeidh/Desktop/THESIS/Enrichment/EnrichmentPlots/Data/",strsplit(x=basename(args[1]),"[.]")[[1]][1],"_null.txt"),quote = F,row.names = F,col.names = T,sep="\t")
write.table(true,paste0("/Users/zeidh/Desktop/THESIS/Enrichment/EnrichmentPlots/Data/",strsplit(x=basename(args[1]),"[.]")[[1]][1],"_true.txt"),quote = F,row.names = F,col.names = T,sep="\t")
write.table(pval,paste0("/Users/zeidh/Desktop/THESIS/Enrichment/EnrichmentPlots/Data/",strsplit(x=basename(args[1]),"[.]")[[1]][1],"_pval.txt"),quote = F,row.names = F,col.names = T,sep="\t")
...
ggplot(null)+geom_violin(aes(gene,enrich,fill=color),lwd=0.9,trim=F) +
	...
	ggsave(paste0("/Users/zeidh/Desktop/THESIS/Enrichment/EnrichmentPlots/",strsplit(x=basename(args[1]),"[.]")[[1]][1],".png"))
